            ...
            <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu fw-bold">
                  ...
                  <li>
                    <a href="{{url('login')}}" data-bs-toggle="modal" data-bs-target="#modallogin" class="dropdown-item">Login</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
        ...
        <div class="col-lg-2 pb-3">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              ...
              <li class="pb-2">
                <a href="#" data-bs-toggle="modal" data-bs-target="#modallogin">Login2</a>
              </li>
              <li class="pb-2">
